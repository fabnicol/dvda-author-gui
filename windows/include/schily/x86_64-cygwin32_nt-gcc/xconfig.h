...
#define NEED_SYS_SELECT_H 1	/* if we need sys/select.h to use select() (this is nonstandard) */
...
#define DEV_MINOR_BITS 16		/* # if bits needed to hold minor device number */
 ...
 */
#define HOST_ALIAS "x86_64-pc-cygwin"		/* Output from config.guess (orig)	*/
#define HOST_SUB "x86_64-pc-cygwin"			/* Output from config.sub (modified)	*/
#define HOST_CPU "x86_64"			/* CPU part from HOST_SUB		*/
#define HOST_VENDOR "pc"		/* VENDOR part from HOST_SUB		*/
#define HOST_OS "cygwin"			/* CPU part from HOST_SUB		*/
